...
Website presenting the OS ecosystem of YouWol.
...
[Running app.](https://platform.youwol.com/applications/@youwol/os/latest)

[Online user-guide](https://l.youwol.com/doc/@youwol/os)

[Developers documentation](https://platform.youwol.com/applications/@youwol/cdn-explorer/latest?package=@youwol/os&tab=doc)

[Package on npm](https://www.npmjs.com/package/@youwol/os)

[Source on GitHub](https://github.com/youwol/os)
    ...
    customization = Customization(
        middlewares = [
            FlowSwitcherMiddleware(
                ...
                oneOf = [
                    WebpackDevServerSwitch(packageName="@youwol/os", port=3020),
                ]
            )
        ]
    )
...
the application can be accessed from [here](http://localhost:2000/applications/@youwol/os/latest)
